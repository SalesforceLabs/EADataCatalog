({
    ...
    refreshTree: function(component, callback) {
        ...
        component.set('v.renderTree', false);
        ...
        assetTypes.forEach(function(assetType) {
            ...
            if (item) {
                ...
                self['list' + capName](component, function(err, assets) {
                    self.addAssetItems(component, assetType, assets, itemCollection);
                    if (idx++ === assetTypes.length - 1) {
                        
                        setTimeout(function() {
                            component.set('v.items', itemCollection.items);
                        }, 1);
                        setTimeout(function() {
                            component.set('v.itemMap', itemCollection.itemMap);
                        }, 1);
                        setTimeout(function() {
                            component.set('v.itemMaps', itemCollection.itemMaps);                            
                        }, 1);
                        setTimeout(function() {
                            component.set('v.assetItemMap', itemCollection.assetItemMap); 
                        }, 1);
                        /*
                        //console.warn('setting v.items');
                        component.set('v.items', itemCollection.items);
                        //console.warn('setting v.itemMap');
                        component.set('v.itemMap', itemCollection.itemMap);
                        //console.warn('setting v.itemMaps');
                        component.set('v.itemMaps', itemCollection.itemMaps);
                        //console.warn('setting v.assetItemMap');                        
                        component.set('v.assetItemMap', itemCollection.assetItemMap);
*/
                        
                        //console.warn('setting renderTree to true');
                        
                        component.set('v.renderTree', true);
                    }
                });
            } else {
                console.error(assetType + ' is not a valid asset type');
                self.updateDiagnostics(component);
                self.logDiagnosticError(component, {msg: assetType + ' is not a valid asset type'});
            }
        });
    ...
    addAssetItems: function(component, nodeLabel, assets, itemCollection) {
		...
		*/
        ...
        var itemMap = itemCollection.itemMap;
        
        var itemMaps = itemCollection.itemMaps;
        
        var assetItemMap = itemCollection.assetItemMap;
    ...
    listAssets: function(component, methodName, callback) {
        ...
        sdk.invokeMethod(context, methodName, methodParameters, $A.getCallback(function(err, data) {
            if (err !== null) {
                ...
                self.logDiagnosticError(component, {msg: 'sdk.invokeMethod ' + methodName + ' error', error: err});
