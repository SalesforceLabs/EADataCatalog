({
    ...
    /*
    <aura:attribute name="namespace" type="String" access="global" description="The namespace to use with managed packages for the proxy" default="datacatalog"/>    
	...
	*/
    ...
    updateDiagnostics: function(component) {
        ...
        if (asset !== null && typeof asset !== 'undefined') {
            ...
            diagnostics.attributes.asset = null;
        }


        // Special case for selectedAsset
        let selectedAsset = component.get('v.selectedAsset');
        if (selectedAsset !== null && typeof selectedAsset !== 'undefined') {
	        diagnostics.attributes.selectedAsset = {
                id: selectedAsset.id,
            ...
            diagnostics.attributes.selectedAsset = null;
        }
    ...
    handleHelp: function(component) {
        let self = this;
        
        self.updateDiagnostics(component);

        let diagnostics = {
            'eaDataCatalogTab': component.get('v.diagnostics'),
            'proxy': component.get('v.proxyDiagnostics'),
            'assetTree': component.get('v.assetTreeDiagnostics')
        };
        ...
        $A.createComponents([
            ["c:eaDataCatalogHelpModal", config],
            ["c:eaDataCatalogModalFooter", {closeAction: closeAction}]
            ...
            if (status === "SUCCESS") {
                ...
                modalBody.set('v.diagnostics', diagnostics);
    ...
    handleArrangeNetwork: function(component) {
        let self = this;
        let options = component.get('v.options');
        self.draw(component, options);
    },    
    ...
    draw: function(component, options, callback) {
        let self = this;
        //var nodes = null;
        //var edges = null;
        var network = null;
        ...
        try {
            ...
            console.error(e);
            self.logDiagnosticError(component, {msg: 'draw exception', exception: e});
        }
    ...
    assetAttributes: {
        ...
        'folder': {
            ...
            image: {
                type: 'static',
				url: '/resource/datacatalog__data_catalog_resources/icons/standard_app.png'
        	},
        	color: {
                node: {
                    background: '#AAAAFF',
        ...
        'dashboard': {
            ...
            image: {
                type: 'static',
				url: '/resource/datacatalog__data_catalog_resources/icons/standard_dashboard_ea.png'
        	},
        	color: {
                node: {},
                edge: {}
        ...
        'lens': {
        	...
        	image: {
                type: 'template',
                url: '/resource/datacatalog__data_catalog_resources/icons/standard_chart.png',
        ...
        'analysis': {
        	...
        	image: {
                type: 'static',
                url: '/resource/datacatalog__data_catalog_resources/icons/standard_story.png'
            },
            color: {
                node: {},
                edge: {}
        ...
        'dataset': {
            ...
            image: {
                type: 'static',
                url: '/resource/datacatalog__data_catalog_resources/icons/standard_dataset.png'
            },
            color: {
                node: {},
                edge: {}
        ...
        'connector': {
        	...
        	image: {
                type: 'template',
                url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png',
                attrs: ['connectorType']
            },
            color: {
                node: {},
        ...
        'csv_datasource': {
        	...
        	image: {
                type: 'static',
                url: '/resource/datacatalog__slds_icons/doctype/csv_120.png'
            },
            color: {
                node: {},
                edge: {}
    ...
    assetImages: {
        'folder': { type: 'dynamic', url: '/resource/datacatalog__data_catalog_resources/icons/standard_app.png'},
        'dashboard': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_dashboard_ea.png'},
        'dataset': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_dataset.png'},
        'lens': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/standard_chart.png', attrs: ['visualizationType']},
        'connector': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png', attrs: ['connectorType']},
        'dataset_connector': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png', attrs: ['connectorType']},
        'replicated_dataset_connector': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png', attrs: ['connectorType']},
        'replicateddataset': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png', attrs: ['connectorType']},
        'replicated_dataset': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}.png', attrs: ['connectorType']},
        'replated_dataset': { type: 'template', url: '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/{{connectorType}}.png', attrs: ['connectorType']},
        'recipe_source_dataset': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_dataset.png'},
        'analysis': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_story.png'},
        'csv_datasource': { type: 'static', url: '/resource/datacatalog__slds_icons/doctype/csv_120.png'},
        'standard_connect': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_connect.png'},
        'broken_image': { type: 'static', url: '/resource/datacatalog__data_catalog_resources/icons/standard_connect.png'}
    },
    ...
    addAssetNode: function(component, asset, relatives, index, network, nodes, edges, fit, select) {
        ...
        let brokenImageType = self.assetImages['broken_image'];
        let brokenImageUrl = brokenImageType.url;
 ...
 */       
    ...
    addAssetChildren: function(component, asset, network, nodes, edges, fit, select) {
        ...
        if (asset.type === 'folder') {
			var folder = asset;
            //console.warn('folder:', JSON.parse(JSON.stringify(folder)));
        ...
        } else if (asset.type === 'dashboard' || asset.type === 'lens') {
            /*
			 * TREAT LENSES JUST LIKE DASHBOARDS
             */
                    ...
                    if (item) {
                        ...
                        self.describeDataset(component, dataset.id, function(err, datasetDetails) {
                            ...
                            if (err) {
                                ...
                                self.logDiagnosticError(component, {msg: 'decribeDataset error', error: err});
            ...
            */
            ...
            if (connector.replicatedDataset) {
                    ...
                    fields.forEach(function(srcField) {
                        ...
                        if (srcField.name === fieldOriginName) {
                            fieldAsset = {
                                ...
                                fullyQualifiedName: srcField.fullyQualifiedName,                                
                ...
                fieldAsset = {
                    ...
                    type: 'origin_field',
                    field: field//,
                    //fullyQualifiedName: srcField.fullyQualifiedName //connector.fullyQualifiedName
                };
                ...
                //console.warn('connector: ', JSON.parse(JSON.stringify(connector)));
                //console.warn('field: ', JSON.parse(JSON.stringify(field)));
                let dataset = connector.dataset;
                
                var srcField = field.field;
                fieldAsset = {
                    id: (connector.dataset.fullyQualifiedName || connector.name || connector.label || 'N/A') + '_field_' + srcField.name,
                    label: srcField.label || srcField.name,
                    type: 'origin_field',
                    field: field,
                    originName: connector.dataset.fullyQualifiedName
                };
                //console.warn('fieldAsset: ', fieldAsset);
                self.addAssetNode(component, fieldAsset, {parents: [connector]}, idx, network, nodes, edges);
                self.addAssetChildren(component, fieldAsset, network, nodes, edges);                
            ...
            //console.warn('asset: ', JSON.parse(JSON.stringify(asset)));
            ...
            if (asset.replicatedDataset) {
                ...
                replicatedDataset.imageUrl = '/resource/datacatalog__data_catalog_resources/icons/connectors/icons/HerokuPostgres.png';
                ...
                let csvDataSourceAsset = {
                    ...
                    type: 'csv_datasource',
                    imageUrl: '/resource/datacatalog__slds_icons/doctype/csv_120.png'
                };
            ...
            } else if (asset.originName) {
                //console.warn('PROBABLY SPECIAL CASE?????');
                let dataSourceAsset = {
                    id: 'Datasource_' + asset.originName,
                    label: asset.originName,
                    type: 'datasource'
                };
                
                self.addAssetNode(component, dataSourceAsset, {parents: [asset]}, 0, network, nodes, edges);
                
                self.addAssetChildren(component, dataSourceAsset, network, nodes, edges);
                
            } else {
                console.warn('No origin datasource found!!!!');
                console.warn('asset: ', JSON.parse(JSON.stringify(asset)));
            ...
            if (connector === 'NOT_API') {
                let fullyQualifiedName = dataset.fullyQualifiedName;
                var connectorAsset = {
                    id: 'connector_' + (connector.id || connector.name || connector.label) + '_' + field.id,
                    label: 'API',
                    type: 'connector',
                    connectorType: 'SalesforceLocal',
            ...
            } else if (connector === 'CSV' || connector === 'eaMigrationService') {
                let fullyQualifiedName = dataset.fullyQualifiedName;
                ...
                self.listRecipes(component, function(err, recipes) {
                    ...
                    if (recipe) {
                        ...
                        //console.warn('no recipe matched!');
                        var connectorAsset = {
                            id: 'connector_' + connector.id + '_' + field.id,
                            label: 'CSV (Upload)',
                            type: 'connector',
                            connectorType: 'CSV',
                            imageUrl: '/resource/datacatalog__data_catalog_resources/icons/csv-upload_120.png',
                            fullyQualifiedName: fullyQualifiedName,
                            field: field
                        };
                        self.addAssetNode(component, connectorAsset, {parents: [field]}, 0, network, nodes, edges);
                ...
                self.listReplicatedDatasets(component, function(err, replicatedDatasets) {
                    ...
                    if (replicatedDataset) {
                        ...
                        var connectorAsset = {
                            id: 'connector_' + (connector.id || connector.name || connector.label || connector) + '_' + field.id,
                        ...
                        //console.warn('connectorAsset: ', connectorAsset);
            ...
            self.logDiagnosticError(component, {msg: 'unhandled asset.type: ' + asset.type});
        }
    ...
    listChildren: function(component, asset, network) {
        //onsole.warn('listChildren: ', asset.type, asset);
    	let children = null;
        let childMap = {};
        let item = null;
        let itemMaps = component.get('v.itemMaps');
        if (asset.children) {
            ...
            if (asset.type === 'fields') {
                ...
                for (var name in itemMap) {
                    assetItem = itemMap[name];
                    dataset = assetItem.asset;
                    if (dataset.folder.id === folder.id) {
                        item = {
                            id: dataset.id,
    ...
    getDatasetFields: function(component, datasetId, versionId, callback) {
        ...
        sdk.invokeMethod(context, methodName, methodParameters, $A.getCallback(function(err, data) {
            ...
            if (err !== null) {
                ...
                self.logDiagnosticError(component, {msg: 'getDatasetFields error', error: err});
    ...
    describeDataset: function(component, datasetId, callback) {
        ...
        sdk.invokeMethod(context, methodName, methodParameters, $A.getCallback(function(err, data) {
            ...
            if (err !== null) {
                ...
                self.logDiagnosticError(component, {msg: 'sdkInvokeMethod ' + methodName + ' error', error: err});
                if (callback !== null && typeof callback !== 'undefined') {
                    callback(err, null);
                } else {
                    return err;
